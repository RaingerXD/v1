...
from bot.helper.PyroHelpers import ReplyCheck
from bot.modules.help import add_command_help
from bot.modules.bot.inline import get_readable_time
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"└• **яєρσ**: [Click](https://GitHub.com/itz-zaid/bot-Userbot)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/itz-zaid/bot-UserBot\nFork & Give an ⭐")
