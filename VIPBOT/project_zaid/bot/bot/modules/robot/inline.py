...
from bot.helper.data import Data
from Ubotlibs.Ubot.helper.inline import inline_wrapper, paginate_help
from bot.database.activedb import *
from bot.database.usersdb import *
from bot.database..accesdb import *
from pyrogram.raw.functions import Ping
from bot import CMD_HELP, StartTime, app, ids, cmds, app
#from config import ADMIN1_ID, ADMIN2_ID, ADMIN3_ID, ADMIN4_ID, ADMIN5_ID
from bot.modules.sudo import ADMINS, OWNER_ID, SUDO_ID, BOT_VER
...
#    ADMIN5 = ADMIN5_ID[0]
    return await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(text="👮‍♂ Admin ", user_id=ADMINS),
