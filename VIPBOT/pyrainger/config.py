...
#SUDO_USERS = getenv("SUDO_USERS", "5615921474, 1620434318, 1442917841")
#OWNER_ID = getenv("OWNER_ID", "5615921474, 1620434318, 1442917841")
#ADMIN1_ID = list(map(int, getenv("ADMIN1_ID", "5615921474").split()))
#ADMINS = getenv("ADMINS", "5615921474, 1620434318, 1442917841")
#DEVS = getenv("DEVS", "5615921474, 1620434318, 1442917841")
#WHITELIST = getenv("WHITELIST", "5615921474, 1620434318, 1442917841")
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://pyrainger:pyrainger@pyrainger.djuurcs.mongodb.net/?retryWrites=true&w=majority")
BOT_TOKEN = getenv("BOT_TOKEN", "6084940874:AAHQhCoTuU3N1xeJycc_qgitJRZBgXZNLUw")
...
BL_GCAST = {int(x) for x in getenv("BL_GCAST", "-1001755737234").split()}
...
SUPPORT = int(getenv("SUPPORT", "-1001755737234"))
CHANNEL = int(getenv("CHANNEL", "-1001824516110"))
