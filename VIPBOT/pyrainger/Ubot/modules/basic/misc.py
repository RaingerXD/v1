...
from Ubotlibs import join, BOT_VER
...
add_command_help(
    ...
    [
        ...
        [f"botlist","Untuk mendapatkan daftar Bot di grup"],
        [f"toanime", "Balas ke foto untuk jadi anime."],
        [f"togif", "Balas ke foto untuk menajdi gif."],
        [f"mms","Untuk membuat random meme."],
        [f"ping","Untuk cek bot."],
    ],
)